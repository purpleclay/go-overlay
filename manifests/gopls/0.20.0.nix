# Auto-generated by goscrapeproxy - do not edit manually
{
  ...
  subPackages = ["."];
  go = "1.24.2";
  hash = "sha256-DlNNBDBZfmdd3JKAXqNj/Wn4uBZrqF4BWTQvRDbQNf4=";
  ...
  mod = {
    ...
    "golang.org/x/telemetry" = {
      ...
      hash = "sha256-BWYS+Tw77joGEY3erqtTQZ6H6mxa4ozwu91du6+FfRM=";
      go = "1.23.0";
