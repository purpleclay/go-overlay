# Auto-generated by goscrapeproxy - do not edit manually
{
  ...
  subPackages = ["."];
  go = "1.25";
  hash = "sha256-WCTzZZCONOi7BCcGSckgBhR0F83S3hiiI9Vrrs+8VPM=";
  ...
  mod = {
    ...
    "github.com/google/jsonschema-go" = {
      version = "v0.3.0";
      hash = "sha256-GIVEtsm2C1nUWa3lOh56Z8dEYS4vRDQeTpiy1mIFXUg=";
      go = "1.23.0";
    ...
    "github.com/modelcontextprotocol/go-sdk" = {
      version = "v0.8.0";
      hash = "sha256-7y3IFIH+aoRoN+RkjR/pH1Ob4tY8YO48AAjgVfOqvQg=";
      go = "1.23.0";
      packages = ["github.com/modelcontextprotocol/go-sdk/auth" "github.com/modelcontextprotocol/go-sdk/internal/jsonrpc2" "github.com/modelcontextprotocol/go-sdk/internal/util" "github.com/modelcontextprotocol/go-sdk/internal/xcontext" "github.com/modelcontextprotocol/go-sdk/jsonrpc" "github.com/modelcontextprotocol/go-sdk/mcp"];
    };
    ...
    "golang.org/x/telemetry" = {
      ...
      hash = "sha256-jQMJmjowlW04fLSt71v1aGWvRtnEiFhs/FJ/Ukc9+wc=";
      go = "1.24.0";
    ...
    "honnef.co/go/tools" = {
      ...
      hash = "sha256-GdpW8NW2ryNEnVRDH6Jls402BYQWYeZUYWlmQKkc1vk=";
      go = "1.23.0";
