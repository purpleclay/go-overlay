# Auto-generated by goscrape - do not edit manually
{
  ...
  subPackages = ["."];
  go = "1.26.0";
  hash = "sha256-Qik60cEvRYvdgRLD7dOUFFl932plQqPcJOc85LuZU5E=";
  ...
  mod = {
    ...
    "golang.org/x/tools" = {
      version = "v0.44.1-0.20260429140723-6a98c5c482af";
      hash = "sha256-n3iFoYIyxtyM5keT/fICdnS1HppElS4mc8bukoKeSBc=";
      go = "1.25.0";
