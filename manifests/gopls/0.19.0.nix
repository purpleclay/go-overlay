# Auto-generated by goscrapeproxy - do not edit manually
{
  ...
  subPackages = ["."];
  go = "1.24.2";
  hash = "sha256-Ckgess8AnI+BOaOVc8EfZcPTs0FhrYsjSOCUx9ogFMo=";
  ...
  mod = {
    ...
    "golang.org/x/telemetry" = {
      version = "v0.0.0-20250417124945-06ef541f3fa3";
      hash = "sha256-RM+w5elT46KWx7uJpjTrXJW9h8kBJ7Jhw8zlR0PPMiY=";
      go = "1.23.0";
    ...
    "honnef.co/go/tools" = {
      version = "v0.7.0-0.dev.0.20250523013057-bbc2f4dd71ea";
      hash = "sha256-FCkku+20QuFqk/H14Ep4RGh9n8CREdy9lVNzSN2bu8c=";
      go = "1.23.0";
