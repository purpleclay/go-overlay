...
func TestIsDriftedGoWork(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			existing: &vendor.Manifest{
				Schema:    vendor.SchemaVersion,
				Workspace: &mod.WorkspaceConfig{Go: "1.22", Modules: []string{"./api"}},
				Mod:       map[string]mod.ModuleConfig{"github.com/foo/bar": {Version: "v1.0.0"}},
			},
			want: false,
		},
		{
			name:   "MissingWorkspaceConfigDrifted",
			goWork: "go 1.22\nuse ./api\n",
			members: map[string]string{
				"api": "module example.com/api\ngo 1.22\nrequire github.com/foo/bar v1.0.0\n",
			},
		...
		{
			name:   "WorkspaceGoVersionChanged",
			goWork: "go 1.24\nuse ./api\n",
			members: map[string]string{
				"api": "module example.com/api\ngo 1.24\nrequire github.com/foo/bar v1.0.0\n",
			},
		...
		{
			name:   "WorkspaceToolchainChanged",
			goWork: "go 1.24\ntoolchain go1.24.1\nuse ./api\n",
			members: map[string]string{
				"api": "module example.com/api\ngo 1.24\nrequire github.com/foo/bar v1.0.0\n",
			},
			existing: &vendor.Manifest{
				Schema:    vendor.SchemaVersion,
				Workspace: &mod.WorkspaceConfig{Go: "1.24", Toolchain: "go1.24.0", Modules: []string{"./api"}},
				Mod:       map[string]mod.ModuleConfig{"github.com/foo/bar": {Version: "v1.0.0"}},
			},
			want: true,
		},
		{
			name:   "WorkspaceToolchainUnchanged",
			goWork: "go 1.24\ntoolchain go1.24.1\nuse ./api\n",
			members: map[string]string{
				"api": "module example.com/api\ngo 1.24\nrequire github.com/foo/bar v1.0.0\n",
			},
			existing: &vendor.Manifest{
				Schema:    vendor.SchemaVersion,
				Workspace: &mod.WorkspaceConfig{Go: "1.24", Toolchain: "go1.24.1", Modules: []string{"./api"}},
				Mod:       map[string]mod.ModuleConfig{"github.com/foo/bar": {Version: "v1.0.0"}},
			},
			want: false,
		},
		{
			name:   "WorkspaceGoVersionUnchanged",
			goWork: "go 1.24\nuse ./api\n",
			members: map[string]string{
				"api": "module example.com/api\ngo 1.24\nrequire github.com/foo/bar v1.0.0\n",
			},
			existing: &vendor.Manifest{
				Schema:    vendor.SchemaVersion,
				Workspace: &mod.WorkspaceConfig{Go: "1.24", Modules: []string{"./api"}},
				Mod:       map[string]mod.ModuleConfig{"github.com/foo/bar": {Version: "v1.0.0"}},
			},
			want: false,
		},
