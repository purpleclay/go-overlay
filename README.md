...
go-overlay provides Nix flake templates to quickly bootstrap new Go projects with proper Nix shells and builders pre-configured.

Initialize a standard Go application boilerplate:

```bash
nix flake init -t github:purpleclay/go-overlay
```

This includes a `flake.nix` utilizing `buildGoApplication` and a ready-to-go directory structure.
...
| Tool                                                                     | Module                                 | Status                                                                                                                                                                                                                                                   |
| :----------------------------------------------------------------------- | :------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [delve](https://pkg.go.dev/github.com/go-delve/delve)                    | `github.com/go-delve/delve`            | [![auto-update](https://img.shields.io/github/actions/workflow/status/purpleclay/go-overlay/delve-update.yml?label=auto-update&logo=nixos&logoColor=white)](https://github.com/purpleclay/go-overlay/actions/workflows/delve-update.yml)                 |
...
| [gopls](https://pkg.go.dev/golang.org/x/tools/gopls)                     | `golang.org/x/tools/gopls`             | [![auto-update](https://img.shields.io/github/actions/workflow/status/purpleclay/go-overlay/gopls-update.yml?label=auto-update&logo=nixos&logoColor=white)](https://github.com/purpleclay/go-overlay/actions/workflows/gopls-update.yml)                 |
...
Tests are disabled by default. Set `doCheck = true` to run `go test` during the build:
...
Tests are scoped to `subPackages`. Use `checkFlags` for additional test flags and `excludedPackages` to skip specific packages:
